...
class RelationshipSpaceDao(
    ...
    fun upsertSpace(
        ...
        coverPhotoVersion: String?,
        couplePhotoUrl: String?,
        couplePhotoVersion: String?,
        ...
        db.relationshipSpacesQueries.upsertRelationshipSpace(
            ...
            cover_photo_version = coverPhotoVersion,
            couple_photo_url = couplePhotoUrl,
            couple_photo_version = couplePhotoVersion,
            relationship_start_date = relationshipStartDate,
            celebrate_monthsary = if (celebrateMonthsary) 1 else 0,
            celebrate_anniversary = if (celebrateAnniversary) 1 else 0,
    ...
    private fun toCard(space: org.noztek.RelationshipSpaces): RelationshipSpaceCardLocal {
        ...
        return RelationshipSpaceCardLocal(
            ...
            coverPhotoVersion = space.cover_photo_version,
            couplePhotoUrl = space.couple_photo_url,
            couplePhotoVersion = space.couple_photo_version,
            relationshipStartDate = space.relationship_start_date,
            celebrateMonthsary = space.celebrate_monthsary == 1L,
            celebrateAnniversary = space.celebrate_anniversary == 1L,
